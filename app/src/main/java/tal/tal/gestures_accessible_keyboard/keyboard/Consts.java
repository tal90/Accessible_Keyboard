...
/** This class holds all the constants of our keyboard..
 * Created by talra on 31-Mar-16.
 */
public class Consts
{
    ...
    public final static String BACKSPACE_KEY_NAME = "Back Space";
    public final static String ENTER_KEY_NAME = "Enter";
    public final static String SYMBOLS_SWITCH_KEY_NAME = "Symbols Switch";
    public final static String ENGLISH_SWITCH_KEY_NAME = "English Switch";
    public final static String HEBREW_SWITCH_KEY_NAME = "Hebrew Switch";
    ...
    public final static String SharedPref_Method_TAG = "Method";

    public final static int MaxAvailableMethods = 3;
}